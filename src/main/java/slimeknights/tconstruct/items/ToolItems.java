...
public final class ToolItems {
  ...
  public static final ItemObject<Item> pickaxe = ITEMS.register("pickaxe", () -> new PickaxeTool(new Item.Properties().group(TinkerRegistry.tabTools), ToolDefinitions.PICKAXE));
}
