...
public class TinkerWorld extends TinkerPulse {
  ...
  public static SlimeTreeFeatureConfig BLUE_SLIME_TREE_CONFIG = injected();

  public static SlimeTreeFeatureConfig BLUE_SLIME_ISLAND_TREE_CONFIG = injected();

  public static SlimeTreeFeatureConfig PURPLE_SLIME_TREE_CONFIG = injected();

  public static SlimeTreeFeatureConfig PURPLE_SLIME_ISLAND_TREE_CONFIG = injected();

  public static SlimeTreeFeatureConfig MAGMA_SLIME_TREE_CONFIG = injected();
