...
public class TankItem extends BlockTooltipItem {
  ...
  public TankItem(Block blockIn, Properties builder) {
    ...
    this.addPropertyOverride(new ResourceLocation("tconstruct","amount"), (stack, world, entity) -> {
  ...
  public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
    ...
    if (stack.hasTag()) {
      ...
      tank.readFromNBT(stack.getTag().getCompound("tank"));
  ...
  public enum TankCapacityGetter implements IItemPropertyGetter {
    ...
    public float call(ItemStack stack, @Nullable World worldIn, @Nullable LivingEntity entity) {
      System.out.println("TankItem.call");
      if (!stack.hasTag()) {
      ...
      if (fluid != null && fluid.getAmount() > 0) {
        System.out.println("fluid != null && fluid.getAmount() > 0");
